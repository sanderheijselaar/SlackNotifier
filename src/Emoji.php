...
/**
 * Emoji is a class for easily getting the right emoji for slack
 *
 * @version 0.1.0
...
Class Emoji
{
    ...
    const WHITE_CIRCLE = ':white_circle:';
    ...
    const SMALL_RED_TRIANGLE = ':small_red_triangle:';
    const SMALL_RED_TRIANGLE_DOWN = ':small_red_triangle_down:';
    const SHIPIT = ':shipit:';
}
